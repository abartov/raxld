...
def cors_set_access_control_headers
  ...
  headers['Access-Control-Allow-Headers'] = "X-Requested-With,Content-Type,Accept"
...
def cors_preflight_check
    headers['Access-Control-Allow-Origin'] = '*'
    headers['Access-Control-Allow-Methods'] = 'POST, GET, OPTIONS'
    headers['Access-Control-Allow-Headers'] = 'X-Requested-With, X-Prototype-Version,Accept'
