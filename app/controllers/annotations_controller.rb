class AnnotationsController < ApplicationController
  ...
  def annotate_with_geonames
	...
	# create annotation
	body = AnnotationBody.new(:mime_type => 'text/html', :content => "<b>#{city.label}</b>, also known as #{city.alt_labels}, is a city in #{SunDawg::CountryIsoTranslater.translate_iso3166_alpha2_to_name(city.country_code)}, with a population of #{city.population}, at an elevation of #{city.elevation}<br/><small>(this comment helpfully auto-generated by the Interedition OAC and Linked Data demo, with data kindly provided by the Geonames folks)</small>")
	body.save!
	anno = Annotation.new(:author_uri => 'http://interedition.eu/') # placeholder...
	# TODO: define a constraint per the term's location!
	anno.construct(body, [{:uri => uri, :constraint => nil}])
